...
URL_PORTADA_MOBILE = "app/static/portada_mobile.jpeg"
...
.col-der {{ flex: 1; background: #000; justify-content: center; align-items: center; position: relative; border-radius: 12px; overflow: hidden; box-shadow: 0 15px 35px rgba(0,0,0,0.15); display: flex; transition: all 0.4s ease; }}
