...
# ==========================================
# 1. RUTAS DE TUS ARCHIVOS ESTÁTICOS Y YOUTUBE
# ==========================================

# VÍDEO INTRO (Pon aquí el ID de tu vídeo de YouTube en Oculto)
...
.col-der {{ flex: 1; background: #000; justify-content: center; align-items: center; position: relative; padding: 0; }}
...
/* AJUSTE DEL IFRAME DE YOUTUBE PARA QUE QUEDE PERFECTO EN LA CAJA */
...
@media (max-width: 768px) {{
    ...
    .card {{ width: 100% !important; height: 380px !important; aspect-ratio: auto !important; display: block; }}
    .card-bg {{ width: 100%; height: 100%; top: 0; left: 0; object-fit: cover; }}
    
    .col-der iframe {{ min-height: 450px; }} /* Ajuste para que el YouTube quede bien en móvil */
...
<div class="col-izq">
<img src="{URL_PORTADA}" alt="Portada">
</div>
<div class="col-der">
